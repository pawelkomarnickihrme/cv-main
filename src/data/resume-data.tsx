...
export const RESUME_DATA = {
  ...
  summary:
    "I am Full Stack Developer with three years of remote work experience, specializing in JavaScript, TypeScript, React, Node.js, and Next.js. Eager to stay abreast of industry innovations, I have a proactive approach to learning new technologies. Renowned for my sense of responsibility and effective communication skills.",
  avatarUrl:
  ...
  work: [
    {
      ...
      description:
        "Developed new modules and maintained existing ones in Next.js and TypeScript, directly for Spider's Web and indirectly for other prominent brands such as Samsung, Chanel, Amazon, and Allegro. Took responsibility for the entire development process, from initial project design to production deployment.",
    },
    {
      company: "Mikronika",
